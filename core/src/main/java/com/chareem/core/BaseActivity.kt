...
//        val progressBar = pDialog?.findViewById(R.id.progressBar) as ProgressBar
     ...
     **/
    override fun showToastMessage(message: String, type: MessageType, duration: Int) {
...
interface BaseImplToast {
    fun showToastMessage(message: String, type: MessageType = MessageType.Success, duration: Int = Toast.LENGTH_LONG)
}

interface BaseImplSnackBar {
    fun showSnackBarMessage(message: String, type: MessageType = MessageType.Success, duration: Int = Snackbar.LENGTH_LONG,
